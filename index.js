...
const BotName = 'NEW STORY BOT'; 
const instagram = 'https://www.instagram.com/sarjananet'; 
const aktif = '08:00 - 20:00';
...
conn.sendMessage(id, 'How to install whatsapp bot on android\n*Tutorial* : https://github.com/NEWSTORYBOT/wa-bot',MessageType.text, { quoted: m } );
}
 //intro grup
...
├ _Ex = .Arti putri_ 
├≽️ *.Couple (Namamu & doi)*
├ _Ex = .Couple putri aurora & pangeran alexander_ 
├≽️ *.Getzodiak*
├ _Ex : .Getzodiak putri aurora & 25-04-2002_ 
├≽️ *.Zodiak (zodiak)*
├ _Ex : .Zodiak libra_ 
├≽️ *.Mimpi (teks)*
├ _Ex : .Mimpi ular_
